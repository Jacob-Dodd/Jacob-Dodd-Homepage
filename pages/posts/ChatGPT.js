  ...
  const Work = () => (
    ...
    <Layout title="ChatGPT">
      ...
      <Container>
        ...
        <br></br>
        <img src="/images/posts/eq1.svg"/>
        <br></br>
        <P>
        where Θ are the parameters of the model, πΘ is the model's policy (i.e. the distribution over actions it takes), and R is the reward signal.
